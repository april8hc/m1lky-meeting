...
export default function Header() {
  ...
  const userName = useAppSelector((meetingApp) => meetingApp.auth.userInfo?.name);
  const isDarkTheme = useAppSelector((meetingApp) => meetingApp.auth.isDarkTheme);
  ...
  const invertTheme = () => {
    const theme = localStorage.getItem("meeting-theme");
    localStorage.setItem("meeting-theme", theme === "light" ? "dark" : "light");
        ...
        <Link to="/">
          <EuiText>
            <h2 style={{ padding: "0 1vw" }}>
              <EuiTextColor color="#0b5cff">M1LKY Meeting</EuiTextColor>
            </h2>
          </EuiText>
        </Link>,
      ],
  ...
  const responsiveSection = [
    {
      items: [
        <Link to="/">
          <EuiText>
            <h2 style={{ padding: "0 1vw" }}>
              <EuiTextColor color="#0b5cff">meeting</EuiTextColor>
            </h2>
          </EuiText>
        </Link>,
      ],
